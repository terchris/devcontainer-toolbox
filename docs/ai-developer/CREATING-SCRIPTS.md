...
| Document | Content |
|----------|---------|
| [creating-install-scripts.md](../contributors/creating-install-scripts.md) | Complete guide for install/config/cmd scripts |
| [creating-service-scripts.md](../contributors/creating-service-scripts.md) | Complete guide for service scripts |
| [libraries.md](../contributors/libraries.md) | Library functions reference |
| [categories.md](../contributors/categories.md) | Valid category values |
...
4. Update [libraries.md](../contributors/libraries.md) with documentation
...
See [testing.md](../contributors/testing.md) for details on the test framework.
See [CI-CD.md](../contributors/CI-CD.md) for what CI checks.
