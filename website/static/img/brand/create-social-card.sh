...
#
# Arguments:
#   Title    - Main heading text. Use \n for line breaks (e.g., "DevContainer\nToolbox")
#   Tagline  - Secondary text below title. Use \n for line breaks
#   logo.svg - Optional. Path to SVG logo (default: cube-dct-green.svg)
...
#
#   # Custom output file
#   ./create-social-card.sh $'My Project' $'A cool tagline.' cube-dct-green.svg my-card.png
#
# Requirements:
...
# Default values
TITLE="${1:-DevContainer\nToolbox}"
TAGLINE="${2:-One command.\nFull dev environment.}"
LOGO="${3:-$SCRIPT_DIR/cube-dct-green.svg}"
OUTPUT="${4:-$SCRIPT_DIR/social-card-generated.png}"

# Colors (matching original social-card.png)
