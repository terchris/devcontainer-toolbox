...
#
# Takes the cube-code-green.svg and copies it as the site logo used by Docusaurus.
#
# Usage:
#   ./publish-logo.sh [source.svg]
#
# Arguments:
#   source.svg - Optional. Source SVG file (default: cube-code-green.svg)
#
# Output:
...
SOURCE="${1:-$SCRIPT_DIR/cube-code-green.svg}"
