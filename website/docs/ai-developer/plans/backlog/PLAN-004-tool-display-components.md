...
## Phase 1: ToolCard Component — PENDING
...
## Phase 2: ToolGrid Component — PENDING
...
- [ ] 2.4 Props: `category` (optional filter), `limit` (optional), `showAll` (boolean)
- [ ] 2.5 Responsive grid: 1 col mobile, 2 col tablet, 3-4 col desktop
- [ ] 2.6 Optional "View All" link when `limit` is set
...
## Phase 3: CategoryCard and CategoryGrid — PENDING
...
- [ ] 3.3 CategoryCard: logo, name, tool count, link to category tools
- [ ] 3.4 CategoryGrid: responsive grid of all categories
- [ ] 3.5 Import from `@site/src/data/categories.json`
...
## Phase 4: Enhanced Tools Page — PENDING

Replace or enhance the current tools page with visual components.

### Tasks

- [ ] 4.1 Create `website/src/pages/tools.tsx` (or MDX with components)
- [ ] 4.2 Display CategoryGrid at top
- [ ] 4.3 Display ToolGrid grouped by category
- [ ] 4.4 Add search/filter by tags (optional for this phase)
- [ ] 4.5 Ensure existing `/docs/tools/` links still work
...
## Phase 5: RelatedTools Component — PENDING
...
- [ ] 5.2 Takes `relatedIds` prop (array of tool IDs)
- [ ] 5.3 Displays as horizontal scrollable row of mini ToolCards
- [ ] 5.4 Integrate into tool detail pages (may require MDX or custom page)
...
- [ ] 6.1 Run full build to verify no errors
- [ ] 6.2 Test on localhost with Chrome
- [ ] 6.3 Verify responsive design on mobile viewport
- [ ] 6.4 Verify all logos load correctly
- [ ] 6.5 Verify links work (tool pages, category pages, external websites)
...
## Phase 7: Commit and Deploy — PENDING

### Tasks

- [ ] 7.1 Commit all changes
- [ ] 7.2 Bump version in version.txt
- [ ] 7.3 Push and create PR
- [ ] 7.4 Verify on deployed site
